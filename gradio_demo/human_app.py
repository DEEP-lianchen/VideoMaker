...
个性化步骤：<br>
1️⃣ 上传你想要定制的人的图像。请确保上传图像的背景除了主体的脸部外是白色的（例如白色的身份证照片）。我们建议使用[Grounded-SAM-2](https://github.com/IDEA-Research/Grounded-SAM-2)或[SAM-2](https://github.com/facebookresearch/sam2)预处理输入图像，以便在参考图像中仅保留面部区域。如果希望保持生成内容中人物着装接近，无需用白色替换着装部分。<br>
2️⃣ 输入文本提示。<br>
